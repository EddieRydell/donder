use donder_elaboration::native_effect::{self, BoundNativeEffect};
...
use donder_language::effect::BuiltinEffect;
...
fn native_parameter_layout_matches_the_compact_runtime_binding() {
    use donder_language::effect::builtin_effect_definition;
    use donder_language::operator::{BuiltinOperator, builtin_operator_definition};
