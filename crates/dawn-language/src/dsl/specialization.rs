...
impl GeneratorProgram {
    ...
    pub fn specialize(
        ...
        let mut specializer = Specializer {
            ...
            max_children,
            remaining_iterations: dawn_runtime::dsl::MAX_VM_INSTRUCTIONS_PER_INVOCATION,
        };
...
impl Specializer<'_> {
    ...
    fn calculate(
        ...
        let uses_time = program.instructions.iter().any(|instruction| {
            matches!(
                instruction,
                dawn_runtime::dsl::bytecode::Instruction::ContextRead {
                    read: dawn_runtime::dsl::bytecode::ContextRead::Seconds
                        | dawn_runtime::dsl::bytecode::ContextRead::Progress,
                    ..
                }
            )
        });
